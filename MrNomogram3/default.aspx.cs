...
namespace MrNomogram3
{
    public class _default : Page
    {
        ...
        protected DropDownList feet;
        protected RequiredFieldValidator feetReqVal;
        protected RangeValidator feetValInteger;
        protected DropDownList inch;
        protected RequiredFieldValidator inchReqVal;
        protected RangeValidator inchValInteger;
        ...
        private void Page_Load(object sender, EventArgs e)
        {
            ...
            this.feet.DataSource = (object)util.listFeet();
            this.inch.DataSource = (object)util.listInches();
        ...
        private void CalculateBtn_Click(object sender, EventArgs E)
        {
            ...
            float cm = conversion.heightTransform(int.Parse(this.feet.SelectedItem.Value), int.Parse(this.inch.SelectedItem.Value));
            float kg = conversion.weightTransform(float.Parse(this.weight.Text));
            ...
            this.MyHeightLabel.Text = "Height = " + this.feet.SelectedItem.Value + " feet " + this.inch.SelectedItem.Value + " inch(es)";
            this.MyGenderLabel.Text = "Gender = " + this.gender.SelectedItem.Text;
            this.MyWeightLabel.Text = "Weight = " + this.weight.Text + " pound(s)";
